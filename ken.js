...
// age = prompt('enter your age');
// console.log(' welcome ' + email + ' your age ' + age + ' ans');


// var home,cyti;
// var age;

// home,cyti = prompt('Enter whit your name');
// age = prompt('enter your homecyti');
// console.log(' welcome ' + home,cyti + ' name of your home cyti ' + ' your age ' + age + ' ans');
...
// name = prompt('Enter whit your name');
// age = prompt('enter your age');
// console.log(' welcome ' + name + ' your age ' + age + ' ans');

// // Step 1: Make a variable for the name
// let name = prompt("What is your name?")

// // Step 1: Make a variable for the name
// let name = prompt("What is your name?")

// // Step 3: Show a welcome message
// console.log("Welcome, " + name + " You're  saking age " + age + " years old.");
